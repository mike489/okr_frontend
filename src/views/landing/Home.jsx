...
const features = [
  {
    ...
    title: 'Roadmaps',
    description:
      'Build beautiful, customizable roadmaps that everyone loves to use.',
    video: roadmapsVideo,
  },
  {
    id: 'portfolio',
  ...
  },
  {
    ...
    description:
      'Collect, organize, and act on customer feedback from every channel.',
    video: feedbackVideo,
  },
  ...
  },
  {
    ...
    description:
      'Align the entire company with cascading goals and real-time progress.',
    video: okrsVideo,
  },
  {
    id: 'capacity',
      ...
      <Box
        sx={{
          ...
          '&::before': {
            ...
            inset: 0,
            background:
              'url(https://images.unsplash.com/photo-1557682250-33bd709cbe85?w=1920&q=80) center/cover',
            opacity: 0.15,
          },
        }}
      >
        ...
        >
          ...
          >
            The #1 OKR platform trusted by 8,000+ high-growth teams. Align
            everyone, track progress in real-time, and hit every ambitious goal.
          </Typography>
          ...
          <Typography
            variant="body2"
            sx={{ mt: 5, opacity: 0.8, color: 'white' }}
          >
                ...
                >
                  <Stack direction="row" spacing={3}>
                    ...
                    >
                      ...
                      {feature.id === 'feedback' && (
                        <Feedback sx={{ fontSize: 36 }} />
                      )}
                      {feature.id === 'prioritization' && (
      ...
      <Box id="pricing" sx={{ bgcolor: '#f8fafc', py: { xs: 10, md: 16 } }}>
        <Container maxWidth="lg">
          ...
          <Typography
            ...
            mx="auto"
          >
            Choose the plan that fits your team. All plans include a{' '}
          ...
          <Box textAlign="center" mt={10}>
            <Typography variant="body1" color="text.secondary">
              <strong>8,000+ teams</strong> trust us • Cancel anytime • No
