          ...
          <Grid container item xs={12} spacing={2} sx={{ mt: 1 }}>
                ...
                sx={{
                  ...
                  boxShadow:
                    activeStatus === 'employees'
                      ? '0 0 8px 4px rgba(245, 222, 255, 0.7)'
                      : 'none',
                  transition: 'background-color 0.3s, box-shadow 0.3s',
                  '&:hover': {
                    backgroundColor: '#e4c6f3',
            ...
            <Grid item xs={12} sm={6} md={3} lg={3} xl={3}>
              <Box
                sx={{
                  ...
                  boxShadow:
                    activeStatus === 'managers'
                      ? '0 0 8px 4px rgba(252, 186, 3, 0.5)'
                      : 'none',
                  transition: 'background-color 0.3s, box-shadow 0.3s',
                  '&:hover': {
                ...
                onClick={() => {
                  setActiveStatus('managers');
                  setSelection('managers');
                }}
              >
                <Box
                  sx={{
            ...
            <Grid item xs={12} sm={6} md={3} lg={3} xl={3}>
              <Box
                ...
                onClick={() => {
                  setActiveStatus('employeesNoTask');
                  setSelection('employeesNoTask');
                }}
              >
                <Box
                  sx={{
                ...
                <StatusCount
                  ...
                  sx={{ ml: 2, cursor: 'pointer' }}
                  onClick={() => {
                    handleStatusClick('employeesNoTask');
                    setSelection('employeesNoTask');
                  }}
                />
              </Box>
            ...
            <Grid item xs={12} sm={6} md={3} lg={3} xl={3}>
              <Box
                ...
                title="Managers"
                onClick={() => {
                  setActiveStatus('managerNoTask');
                  setSelection('managerNoTask');
                }}
              >
                <Box
                  sx={{
                ...
                <StatusCount
                  ...
                  sx={{ ml: 2, cursor: 'pointer' }}
                  onClick={() => {
                    handleStatusClick('managerNoTask');
                    setSelection('managerNoTask');
                  }}
                />
              </Box>
