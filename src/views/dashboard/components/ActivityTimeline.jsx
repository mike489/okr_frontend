...
const ActivityTimeline = ({ sx, ...other }) => {
  ...
  const mockActivityTimelineData = [
    {
      "id": 1,
      "name": "Q1 Performance Evaluation",
    ...
    {
      "id": 3,
      "name": "Q3 Performance Evaluation",
      "start_date": "2023-10-01",
      "end_date": "2023-10-15",
      "timeline_status": false,
      "description": "Third quarter performance review period"
    },
    {
      "id": 4,
      "name": "Annual Review",
      ...
      "end_date": "2024-01-31",
      "timeline_status": false,
      "description": "Complete annual performance evaluation"
    },
    {
      "id": 5,
      "name": "Fiscal Year Planning",
      "start_date": "2023-03-01",
      "end_date": "2023-03-15",
      "timeline_status": true,
      "description": "Set objectives for the new fiscal year"
    }
  ];
  const [loading, setLoading] = useState(true);
  const [error, setError] = useState(false);
  const [data, setData] = useState(mockActivityTimelineData);
