  ...
  return (
    <React.Fragment>
      {loading ? (
        ...
        <Fallbacks severity="task" title={`There is no plan found`} description="" sx={{ paddingTop: 6 }} />
      ) : (
      ...
      {selectedPlanID && (
        <UpdatePlan add={update} plan_id={selectedPlanID} onClose={handleUpdateModalClose} onSucceed={() => refresh()} isUpdate={true} />
      )}
      {deletePlan && (
        <DeletePrompt
          type="Delete"
