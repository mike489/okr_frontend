                        ...
                        <Table sx={{ minWidth: 650 }} aria-label="Organization plan table">
                          <TableHead>
                            <TableRow>
                              ...
                              {page === 'evaluation' && plan?.target.some((target) => target.can_be_evaluate === true) && (
                                <TableCell>Action</TableCell>
                              )}
                            </TableRow>
                          </TableHead>
                          <TableBody>
                            {plan?.target?.map((target, index) => (
                              ...
                              >
                                ...
                                <TableCell sx={{ border: 0 }}>{target?.monthly_actual}</TableCell>
                                <TableCell sx={{ border: 0 }}>{target?.actual_value}</TableCell>
                                {page === 'evaluation' && target?.can_be_evaluate && (
                                  <TableCell sx={{ border: 0 }}>
                                    <Button
                                      variant="text"
                                      sx={{ boxShadow: 0 }}
